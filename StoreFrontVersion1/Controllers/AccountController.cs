...
using ModelView;
using StoreFrontVersion1.Models;
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    Session["CustId"] = Convert.ToString(dt.Rows[0]["CustId"]);
                    Session["CustName"] = Convert.ToString(dt.Rows[0]["CustName"]);
                    Session["CPCName"] = Convert.ToString(dt.Rows[0]["CustName"]);
                    Session["CustCategeory"] = Convert.ToString(dt.Rows[0]["CustCategeory"]);
                    Session["Completemsg"] = "No";
                    Session["Dothis"] = "0";
                  
                    Session["Tab"] = "1";
                    if (Session["CustCategeory"].ToString() == "CP")
                        return RedirectToAction("Index", "CPC");
                    else if (Session["CustCategeory"].ToString() == "CPC")
